      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <NavLink to="/articles">Career Tips</NavLink>
            {(role === "Employer" || role === "Admin") && (
              <NavLink to="/dashboard" special>Start Hiring</NavLink>
            )}
          </div>
      ...
      {!user ? (
        ...
        <>
          <div className="flex items-center space-x-3">
            ...
            <div className="w-9 h-9 bg-gradient-to-r from-teal-600 to-emerald-500 rounded-full flex items-center justify-center shadow-md">
            ...
            {!user ? (
              ...
              <div className="flex flex-col space-y-3">
                <div className="flex items-center space-x-3 px-4 py-2">
                  <div className="w-9 h-9 bg-gradient-to-r from-purple-600 to-blue-500 rounded-full flex items-center justify-center shadow-md">
                    <span className="text-white font-bold text-sm">
                      {user.displayName?.charAt(0) || user.email?.charAt(0).toUpperCase()}
                    </span>
                  </div>
